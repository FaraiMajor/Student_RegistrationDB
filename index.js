...
//Router for post request to add data to the studenttable
...
//Router for get request to get all data from the student table
...
//Router for get request to get both the ids and names from the student table
